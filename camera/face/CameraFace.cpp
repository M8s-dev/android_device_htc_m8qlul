...
class CameraFace {
    ...
    int getParameters(android::CameraParameters&) const;
    ...
    int processPreview(unsigned char* a, android::CameraParameters&, int b, android::faceBeauty_config_type* c, android::face_info_t* d, android::multi_face_info_t* e, camera_frame_metadata *f);
...
int CameraFace::getParameters(android::CameraParameters&) const { return 0;  }
int CameraFace::processPreview(unsigned char* a, android::CameraParameters&, int b, android::faceBeauty_config_type* c, android::face_info_t* d, android::multi_face_info_t* e, camera_frame_metadata* f) { return 0; }
